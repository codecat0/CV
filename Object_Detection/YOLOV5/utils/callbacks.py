...
class LossHistory(object):
    ...
    def loss_plot(self):
        ...
        plt.figure()
        plt.plot(iters, self.loss, linewidth=2, label='train loss')
        ...
        try:
            ...
            plt.plot(iters, signal.savgol_filter(self.loss, num, 3), linestyle='--', linewidth=2, label='smooth train loss')
            plt.plot(iters, signal.savgol_filter(self.val_loss, num, 3), linestyle='--', linewidth=2, label='smooth val loss')
        except:
            pass
