...
from dataset.dataset import PSPNetDataset, pspnet_dataset_collate
from nets.pspnet import PSPNet
from nets.pspnet import weights_init
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', type=str, default='./model_data/pspnet_resnet50.pth')
