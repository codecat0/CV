...
if __name__ == '__main__':
    deeplab_predictor = DeepLabPredictor()
    ...
    if mode == 'predict':
        while True:
            ...
            try:
                ...
                r_image = deeplab_predictor.detect_image(image)
    ...
    # 视频检测
        ...
        while True:
            ...
            # 进行检测
            frame = np.array(deeplab_predictor.detect_image(frame))
    ...
    # 测试fps
        ...
        try:
            ...
            tact_time = deeplab_predictor.get_FPS(image, test_interval)
